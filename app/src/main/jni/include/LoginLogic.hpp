...
void doHandleGuestLink( const char *hostC,  VidyoUint port, const char* keyC, const char*  userNameC, const char*  pinC, LmiBool useHTTP);
...
LmiBool doGetLoggedInWithToken();
