...
/*!
 * @defgroup VidyoClientLogModule Csjlogger.infong
...
/** @} */
/*! Csjlogger.infong configuration structure type.

	Csjlogger.infong configuration structure type, pointer to which is passed in call to #VidyoClientStart() and #VidyoClientInitialize()
*/
