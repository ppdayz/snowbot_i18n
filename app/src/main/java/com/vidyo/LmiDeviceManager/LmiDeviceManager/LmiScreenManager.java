...
public class LmiScreenManager extends OrientationEventListener {
	...
	public LmiScreenManager(final Context context, final ByteBuffer pointerwrapper){
		...
		getDisplays();
		Csjlogger.debug(TAG, "LmiScreenManager construct done in java");
	}
	...
	public void onOrientationChanged(int orientation) {
		...
		if(oldRotation != deviceRotation){
			Csjlogger.debug(TAG, "LmiScreenManager new rotatation in java");
			getDisplays();
	...
	public boolean start(){
		...
		Csjlogger.debug(TAG, "LmiScreenManager started in java");
		return s;
	}
	...
	public void stop(){
		listener.stop();
		disable();		
		Csjlogger.debug(TAG, "LmiScreenManager stopped in java");
	}
