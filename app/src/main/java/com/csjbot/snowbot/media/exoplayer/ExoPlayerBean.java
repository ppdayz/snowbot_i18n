 ...
 */
public class ExoPlayerBean implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         *
         * @param player The player for which renderers are being built. {@link ExoPlayerBean#onRenderers}
         *               should be invoked once the renderers have been built. If building fails,
         *               {@link ExoPlayerBean#onRenderersError} should be invoked.
         */
        void buildRenderers(ExoPlayerBean player);

        /**
         * Cancels the current build operation, if there is one. Else does nothing.
         * <p>
         * A canceled build operation must not invoke {@link ExoPlayerBean#onRenderers} or
         * {@link ExoPlayerBean#onRenderersError} on the player, which may have been released.
         */
        void cancel();
    }
...
//                            float pixelWidthHeightRatio);
    ...
    public ExoPlayerBean(RendererBuilder rendererBuilder) {
     ...
     *
     * @param renderers      Renderers indexed by {@link ExoPlayerBean} TYPE_* constants. An individual
