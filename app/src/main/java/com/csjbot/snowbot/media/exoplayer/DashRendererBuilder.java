package com.csjbot.snowbot.media.exoplayer;/*
...
/**
 */
public class DashRendererBuilder implements ExoPlayerBean.RendererBuilder {
  ...
  @Override
  public void buildRenderers(ExoPlayerBean player) {
  ...
  private static final class AsyncRendererBuilder
    ...
    private final String userAgent;
    private final MediaDrmCallback drmCallback;
    private final ExoPlayerBean player;
    ...
    public AsyncRendererBuilder(Context context, String userAgent, String url,
        MediaDrmCallback drmCallback, ExoPlayerBean player) {
      this.context = context;
      this.userAgent = userAgent;
      this.drmCallback = drmCallback;
      this.player = player;
    ...
    public void onTimestampError(UtcTimingElement utcTiming, IOException e) {
      ...
      Csjlogger.error(TAG, "Failed to resolve UtcTiming element [" + utcTiming + "]", e);
    ...
    private void buildRenderers() {
      ...
      ChunkSource videoChunkSource = new DashChunkSource(manifestFetcher,
          ...
          elapsedRealtimeOffset, mainHandler, player, ExoPlayerBean.TYPE_VIDEO);
      ChunkSampleSource videoSampleSource = new ChunkSampleSource(videoChunkSource, loadControl,
          VIDEO_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
              ExoPlayerBean.TYPE_VIDEO);
      ...
      ChunkSource audioChunkSource = new DashChunkSource(manifestFetcher,
          ...
          elapsedRealtimeOffset, mainHandler, player, ExoPlayerBean.TYPE_AUDIO);
      ChunkSampleSource audioSampleSource = new ChunkSampleSource(audioChunkSource, loadControl,
          AUDIO_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
              ExoPlayerBean.TYPE_AUDIO);
      ...
      ChunkSource textChunkSource = new DashChunkSource(manifestFetcher,
          ...
          elapsedRealtimeOffset, mainHandler, player, ExoPlayerBean.TYPE_TEXT);
      ChunkSampleSource textSampleSource = new ChunkSampleSource(textChunkSource, loadControl,
          TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
              ExoPlayerBean.TYPE_TEXT);
      TrackRenderer textRenderer = new TextTrackRenderer(textSampleSource, player,
          mainHandler.getLooper());

      // Invoke the callback.
      TrackRenderer[] renderers = new TrackRenderer[ExoPlayerBean.RENDERER_COUNT];
      renderers[ExoPlayerBean.TYPE_VIDEO] = videoRenderer;
      renderers[ExoPlayerBean.TYPE_AUDIO] = audioRenderer;
      renderers[ExoPlayerBean.TYPE_TEXT] = textRenderer;
