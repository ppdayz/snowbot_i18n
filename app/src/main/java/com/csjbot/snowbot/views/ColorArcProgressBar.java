...
public class ColorArcProgressBar extends View {
    ...
    private String bgArcColor = "#00000000";
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        colors = new int[]{color1,color1, color2,color2, color3, color3};
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //设置渐变色
        rotateMatrix.setRotate(26, centerX, centerY);
        sweepGradient.setLocalMatrix(rotateMatrix);
        progressPaint.setShader(sweepGradient);

        //当前进度
        canvas.drawArc(bgRect, 30, currentAngle, false, progressPaint);
        ...
        if (isNeedTitle) {
            canvas.drawText(titleString, centerX, centerY + 6 * textSize / 3, curSpeedPaint);
        }
