package com.csjbot.snowbot.views.aiui;
...
public class SmartisanTime extends View {
    ...
    private static final int HOUR_WIDTH = 30;

    private static final int MINUTE_WIDTH = 25;
    ...
    private void initPaint() {
        ...
        minutePaint.setStrokeWidth(MINUTE_WIDTH);
        //设置为圆角
...
//        int height = startMeasure(heightMeasureSpec);
    ...
    private void drawScale(Canvas canvas) {
        ...
        canvas.drawText("6", scaleWidth / 2, radius - 30 - dp2px(textSize), timeTextPaint);
        scaleWidth = timeTextPaint.measureText("9");
        canvas.drawText("9", -radius + 30 + dp2px(textSize), -scaleWidth / 2, timeTextPaint);
        canvas.restore();
    }
