...
public class NewsActivity extends AIUIActivity implements ExoPlayerBean.Listener {
    ...
    public void afterViewCreated(Bundle savedInstanceState) {
        ...
        isClickEvent = getIntent().getBooleanExtra("clickEvent", false);
    ...
    public void onStateChanged(boolean playWhenReady, int playbackState) {
        ...
        switch (playbackState) {
            ...
            case ExoPlayer.STATE_ENDED:
                ...
                postEvent(new ExpressionEvent(Constant.Expression.EXPRESSION_NORMAL));
                if (!isClickEvent) {
                    postEvent(new AIUIEvent(EventsConstants.AIUIEvents.MUSICX_NEWS_END));
